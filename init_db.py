...
cur.execute(''' CREATE TABLE IF NOT EXISTS reports (id serial PRIMARY KEY, no_laporan varchar(255), user_id integer, nama_pengadu varchar(255), jenis_pengaduan varchar(255), lokasi varchar(255), keluhan varchar(255), image_url varchar(255), status boolean, created_at timestamp, updated_at timestamp)''')
